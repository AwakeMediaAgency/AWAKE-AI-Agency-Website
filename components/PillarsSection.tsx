...
const PillarsSection: React.FC = () => {
  return (
    <section className="py-40 px-4 relative bg-brand-dark" id="services">
      <div className="max-w-7xl mx-auto">
        <div className="mb-24">
          <h2 className="text-sm font-bold uppercase tracking-[0.5em] text-brand-blue mb-8">Phase 02: Solve</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-10 auto-rows-[350px]">
          {/* Main Feature - Large */}
          <div className="md:col-span-3 lg:col-span-6 row-span-2 p-14 glass rounded-[60px] border-brand-blue/20 group relative overflow-hidden flex flex-col justify-end">
            <div className="absolute top-0 right-0 p-16 opacity-5 group-hover:opacity-10 transition-opacity">
              {PILLARS[0].icon}
            </div>
            <div className="relative z-10">
              <div className="inline-block px-5 py-2 bg-brand-blue text-xs font-bold uppercase tracking-widest rounded-full mb-8 shadow-lg shadow-brand-blue/30">Critical Win</div>
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-brand-blue/5 group-hover:to-brand-blue/10 transition-colors"></div>
          </div>
          ...
          <div className="md:col-span-3 lg:col-span-6 p-14 glass rounded-[60px] group relative overflow-hidden">
            <div className="flex items-start justify-between mb-16">
              <div className="p-6 rounded-2xl bg-white/5 text-brand-blue group-hover:scale-110 transition-transform">{PILLARS[1].icon}</div>
          ...
          <div className="md:col-span-3 lg:col-span-3 p-10 glass rounded-[50px] group relative overflow-hidden flex flex-col justify-between">
            <div className="p-6 rounded-2xl bg-white/5 text-brand-blue w-fit group-hover:rotate-6 transition-transform">{PILLARS[2].icon}</div>
            <div>
          ...
          <div className="md:col-span-3 lg:col-span-3 p-10 glass rounded-[50px] group relative overflow-hidden flex flex-col justify-between">
            <div className="p-6 rounded-2xl bg-white/5 text-brand-blue w-fit group-hover:-rotate-6 transition-transform">{PILLARS[3].icon}</div>
            <div>
          ...
          {/* Special "1-of-1" Card */}
          <div className="col-span-full p-16 bg-brand-blue rounded-[60px] relative overflow-hidden group">
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-16">
              ...
              <button className="flex-shrink-0 px-16 py-8 bg-white text-brand-blue rounded-3xl font-black uppercase tracking-[0.2em] text-xl hover:scale-105 transition-transform shadow-3xl">
                Get a Strategy Call
              </button>
            </div>
          </div>
