...
const Features: React.FC = () => {
  return (
    <section id="expertise" className="py-32 bg-[#02040a] relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-[#1f75fe]/5 rounded-full blur-[120px] pointer-events-none"></div>
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-24 gap-8">
          <div>
            <span className="inline-block text-[#1f75fe] font-bold tracking-[0.4em] uppercase mb-4 text-[10px]">Our Expertise</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-6 h-auto">
          ...
          <div className="md:col-span-4 bg-gradient-to-br from-white/[0.08] to-transparent border border-white/5 rounded-[40px] p-10 flex flex-col justify-between group overflow-hidden relative min-h-[450px]">
            <div className="absolute inset-0 bg-gradient-to-br from-[#1f75fe]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            <div className="relative z-10">
              <div className="w-16 h-16 bg-[#1f75fe] rounded-2xl flex items-center justify-center mb-8 transition-transform duration-500 group-hover:rotate-12">
            ...
            <div className="relative mt-10 h-32 flex items-end gap-2 overflow-hidden">
                {[40, 60, 30, 80, 50, 90, 70, 45, 85, 65].map((h, i) => (
                    <div key={i} className="flex-1 bg-[#1f75fe]/20 rounded-t-lg transition-all duration-1000 group-hover:bg-[#1f75fe]" style={{ height: `${h}%` }}></div>
                ))}
            </div>
          </div>
          ...
          <div className="md:col-span-2 bg-white/[0.03] border border-white/5 rounded-[40px] p-8 flex flex-col justify-center relative group overflow-hidden">
            <div className="absolute top-0 right-0 p-8 opacity-0 group-hover:opacity-100 transition-all transform translate-x-4 group-hover:translate-x-0">
              <ArrowUpRight className="w-8 h-8 text-[#1f75fe]" />
            </div>
          ...
          <div className="md:col-span-3 bg-white/[0.03] border border-white/5 rounded-[40px] p-8 flex flex-col justify-center relative group overflow-hidden">
            ...
            <Target className="w-10 h-10 text-[#1f75fe] mb-6" />
          ...
          {/* Rapid Iteration */}
          <div className="md:col-span-3 bg-white/[0.03] border border-white/5 rounded-[40px] p-8 flex flex-col justify-center relative group overflow-hidden">
            <Zap className="w-10 h-10 text-[#1f75fe] mb-6" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className="bg-white/[0.02] border border-white/5 rounded-3xl p-6 flex items-center gap-4">
            <div className="p-3 bg-white/5 rounded-xl"><Layers className="w-6 h-6 text-[#1f75fe]" /></div>
            <div>
