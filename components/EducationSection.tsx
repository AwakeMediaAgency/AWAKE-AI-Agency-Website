    ...
    <section className="py-32 bg-brand-dark relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-24">
          <span className="inline-block text-brand-blue font-bold tracking-[0.4em] uppercase mb-6 text-sm">AI in Plain English</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="glass rounded-[60px] p-12 border-white/5 relative group overflow-hidden">
            <div className="absolute top-0 right-0 p-12 text-brand-blue/20 group-hover:text-brand-blue/40 transition-colors">
              <Bot className="w-24 h-24" />
            </div>
            <h3 className="text-4xl font-black mb-8 uppercase italic tracking-tighter text-brand-blue">What is AI Automation?</h3>
            ...
            <div className="flex items-center gap-4 p-6 bg-white/5 rounded-3xl border border-white/10">
              <div className="p-3 bg-brand-blue rounded-xl"><Sparkles className="w-6 h-6 text-white" /></div>
          ...
          <div className="glass rounded-[60px] p-12 border-white/5 relative group overflow-hidden">
            ...
            <h3 className="text-4xl font-black mb-8 uppercase italic tracking-tighter text-brand-blue">How it Works</h3>
            <p className="text-2xl text-[#99A1AF] font-light leading-relaxed mb-8">
            ...
            <div className="flex items-center gap-4 p-6 bg-white/5 rounded-3xl border border-white/10">
              <div className="p-3 bg-brand-blue rounded-xl"><Zap className="w-6 h-6 text-white" /></div>
