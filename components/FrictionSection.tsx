...
const FrictionSection: React.FC = () => {
  return (
    <section className="py-24 px-4 bg-[#0A0A0A] relative" id="discovery">
      <div className="max-w-7xl mx-auto">
        <div className="mb-16">
          <h2 className="text-xs font-bold uppercase tracking-[0.3em] text-[#1f75fe] mb-4">Phase 01: Identify</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {IDENTIFY_TESTS.map((test, idx) => (
            <div 
              key={idx} 
              className="group p-8 glass rounded-3xl border border-white/5 hover:border-[#1f75fe]/30 transition-all duration-500 hover:-translate-y-2"
            >
              ...
              <div className="pt-6 border-t border-white/5">
                <span className="text-[10px] font-bold uppercase tracking-widest text-[#1f75fe]">Target</span>
